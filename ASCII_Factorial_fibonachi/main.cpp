...

{
	...
	int a = 1;
	int b; cout << "¬ведите число, факториал которого хотите узнать: "; cin >> b;
	...
	int a; cout << "¬ведите число: "; cin >> a;
	int b; cout << "¬ведите степень, в которую хотите возвести число: "; cin >> b;
	int c = a;
	for (int i = 1; i < b; i++)
	{
		c = c * a;
	...
	int simple = 1;
	int novoe = 1;
	int predel; cout << "ѕредел: "; cin >> predel;
	...
	int simple = 1;
	int novoe = 1;
	int kolichestvo; cout << "¬ведите количество чисел из р€да ‘ибоначчи: "; cin >> kolichestvo;
