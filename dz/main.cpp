...

{
	...
	char zvezda = 42;
	int razmer;
	cout << "¬ведите размер квадрата: "; cin >> razmer;
	...
	char zvezda = 42;
	int razmer; cout << "¬ведите размер треугольника: "; cin >> razmer;
	int otstup = 1;
	...
	int razmer; cout << "¬ведите размер квадрата: "; cin >> razmer;
	int n = -1; //чтобы квадрат начиналс€ с плюса, ибо по системе счислени€ ASCII - 43 = '+', 45 = '-'
